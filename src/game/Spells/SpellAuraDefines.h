...
enum AuraType
{
    ...
    SPELL_AURA_TRANSFER_TOTEM_THREAT = 200,
    SPELL_AURA_TRIGGER_AURA_ON_TOTEMS = 201,
    SPELL_AURA_MOD_PET_STAT_PERCENT_OF_OWNER = 202,
    SPELL_AURA_MOD_PET_ARMOR_PERCENT_OF_OWNER = 203,
    SPELL_AURA_MOD_PET_RESISTANCE_PERCENT_OF_OWNER = 204,
    SPELL_AURA_MOD_PET_ATTACK_POWER_PERCENT_OF_OWNER = 205,
    SPELL_AURA_MOD_PET_SPELL_DAMAGE_PERCENT_OF_OWNER = 206,
    SPELL_AURA_MOD_ATTACK_AND_SPELL_RANGE = 207,
    SPELL_AURA_MOD_REAGENT_CONSUMPTION_CHANCE = 208,
    SPELL_AURA_MOD_MECHANIC_DURATION = 209,
    SPELL_AURA_MOD_SELF_RESURRECTION_RECOVERY = 210,
    SPELL_AURA_MOD_PET_SPELL_CRIT_PERCENT_OF_OWNER = 211,
    SPELL_AURA_MOD_IGNORE_TARGET_ARMOR = 212,
    SPELL_AURA_MOD_SPELL_DAMAGE_OF_INTELLECT_PERCENT = 213,
    SPELL_AURA_MOD_MANA_GAIN_PERCENT = 214,
    SPELL_AURA_MOD_PET_SPELL_HIT_PERCENT_OF_OWNER = 215,
    SPELL_AURA_MOD_PET_MELEE_HIT_PERCENT_OF_OWNER = 216,
    SPELL_AURA_MOD_ENERGY_REGEN_TIME = 217,
    SPELL_AURA_PERIODIC_TRIGGER_SPELL2 = 218,
    SPELL_AURA_219 = 219,
    SPELL_AURA_MOD_DAMAGE_TAKEN_FROM_CASTER_PET = 220,
    SPELL_AURA_MOD_ATTACK_POWER_AREA = 221,
    SPELL_AURA_MOD_ATTACK_POWER_PERCENT_AREA = 222,
    SPELL_AURA_MOD_ITEM_PROC_CHANCE = 223,
    SPELL_AURA_MOD_BLOCK_DAMAGE_PERCENT = 224,
    SPELL_AURA_MOD_GATHERING_ITEM_CHANCE = 225,
    SPELL_AURA_MOD_RAGE_FROM_DAMAGE_DEALT = 226,
    SPELL_AURA_MOD_ATTACKING_RAGE_PERCENT = 227,
    SPELL_AURA_MOD_SKILL_CAST_TIME = 228,
    SPELL_AURA_MOD_PERIODIC_DAMAGE_PERCENT_DONE = 229,
    SPELL_AURA_MOD_CHAIN_DAMAGE_PERCENT_TAKEN = 230,
    TOTAL_AURAS=231
};
