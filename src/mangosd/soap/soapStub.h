/* soapStub.h
   Generated by gSOAP 2.8.135 for gsoap_mangos.h
...
struct ns1__executeCommandResponse;	/* gsoap_mangos.h:6 */
struct ns1__executeCommand;	/* gsoap_mangos.h:6 */
...
\******************************************************************************/
    ...
    /** Web service synchronous operation 'soap_call_ns1__executeCommand' to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    ...
    /** Web service asynchronous operation 'soap_send_ns1__executeCommand' to send a request message to the specified endpoint and SOAP Action header, returns SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 soap_send_ns1__executeCommand(struct soap *soap, const char *soap_endpoint, const char *soap_action, char *command);
    /** Web service asynchronous operation 'soap_recv_ns1__executeCommand' to receive a response message from the connected endpoint, returns SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 soap_recv_ns1__executeCommand(struct soap *soap, char **result);
